...
const listTodos = (todos, activeList, Node) =>
  [...todos]
...
const dueOrPassed = (todos, activeList, Node) =>
  [...todos]
    .filter(
      (todo) =>
...
const currentTodos = (todos, activeList, Node) =>
...
const addFormIf = (firstParam, secondParam, Node) =>
  firstParam === secondParam ? '' : Node(firstParam);
